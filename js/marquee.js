...
function run_marquee() {
    var marquee_text = [
        ...
        "You've made it! If your computer is running this at the same speed as mine, this has been over twenty minues of your life wasted reading all this stuff, so I hope the reward makes up for it to some degree. This used to contain a link to a special hidden page on the website, but Jayesh, this is for you. If you really want to hit no, you should just disable javascript on your browser! You wouldn't have had to sit through this whole silly thing.",
